// Código FIFA (3 letras) → ISO 3166-1 alpha-2 (minúsculo) para montar a URL da
// bandeira real (flagcdn). Espelha apps/app/lib/flags.ts (mesma estratégia da
// duplicação intencional de links.ts / brasilFixtures.ts entre landing e app).
// Resolve o emoji de bandeira que não renderiza no Windows.
